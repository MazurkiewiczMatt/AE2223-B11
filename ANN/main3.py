...
def test_prediction(index, W1, b1, W2, b2, X, Y):
    ...
    names = ['Aeroflot', 'Airbus', 'Antonov', 'Emirates', 'KLM', 'Lufthansa', 'Military turbofan', 'Military turboprop', 'THY', 'TU Delft']
...
n, m, X_train, Y_train, X_valid, Y_valid = load_data('y.csv')
